...
import binplus.FoodWill.Fragment.*;
import binplus.FoodWill.Adapter.ExpandableListAdapter;
import binplus.FoodWill.Config.BaseURL;
import binplus.FoodWill.Config.SharedPref;
import binplus.FoodWill.Fragment.About_us_fragment;
import binplus.FoodWill.Fragment.Contact_Us_fragment;
import binplus.FoodWill.Fragment.Empty_cart_fragment;
import binplus.FoodWill.Fragment.Home_fragment;
import binplus.FoodWill.Fragment.Cart_fragment;
import binplus.FoodWill.Fragment.Edit_profile_fragment;
import binplus.FoodWill.Fragment.Shop_Now_fragment;
import binplus.FoodWill.Fragment.Terms_and_Condition_fragment;
import binplus.FoodWill.Model.MenuModel;
...
import binplus.FoodWill.util.DatabaseHandler;
...
redirect(fb_link);
            ...
            Intent intent=new Intent(MainActivity.this,Verfication_activity.class);
        ...
        CustomVolleyJsonArrayRequest jsonRequest = new CustomVolleyJsonArrayRequest(Request.Method.POST,BaseURL.GET_LINKS, params, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    extra_charges = object.getString("sanitization");
